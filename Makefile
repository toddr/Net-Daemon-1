# This Makefile is for the Net::Daemon extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Net/Daemon.pm]
#     AUTHOR => q[Jochen Wiedmann (joe@ispsoft.de)]
#     BUILD_REQUIRES => {  }
#     NAME => q[Net::Daemon]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Net/Daemon.pm]
#     dist => { DIST_DEFAULT=>q[all tardist], COMPRESS=>q[gzip -9vf], SUFFIX=>q[.gz] }
#     realclean => { FILES=>q[t/config ndtest.prt] }
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Net/Daemon.pm \
	lib/Net/Daemon/Log.pm \
	lib/Net/Daemon/Test.pm
...
TO_INST_PM = lib/Net/Daemon.pm \
	lib/Net/Daemon/Log.pm \
	lib/Net/Daemon/Test.pm

PM_TO_BLIB = lib/Net/Daemon/Test.pm \
...
Daemon.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Net::Daemon\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Net/Daemon/Test.pm $(INST_MAN3DIR)\Net.Daemon.Test.$(MAN3EXT) \
	  lib/Net/Daemon/Log.pm $(INST_MAN3DIR)\Net.Daemon.Log.$(MAN3EXT) \
	  lib/Net/Daemon.pm $(INST_MAN3DIR)\Net.Daemon.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:               Net-Daemon" >> META_new.yml
	$(NOECHO) $(ECHO) "version:            0.44" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:           Perl extension for portable daemons" >> META_new.yml
	$(NOECHO) $(ECHO) "author:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - Jochen Wiedmann (joe@ispsoft.de)" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Perl extension for portable daemons</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Jochen Wiedmann (joe@ispsoft.de)</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/Net/Daemon/Test.pm blib\lib\Net\Daemon\Test.pm \
	  lib/Net/Daemon/Log.pm blib\lib\Net\Daemon\Log.pm \
	  lib/Net/Daemon.pm blib\lib\Net\Daemon.pm 
